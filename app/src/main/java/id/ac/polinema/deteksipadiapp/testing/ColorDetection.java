...
public class ColorDetection extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                if (ContextCompat.checkSelfPermission(ColorDetection.this, Manifest.permission.CAMERA)
                        == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(ColorDetection.this, new String[]{Manifest.permission.CAMERA}, MY_PERMISSIONS_REQUEST_CAMERA);
                }
        ...
        public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
                ...
                take_image=take_picture_function(take_image,imgHSV);
                return imgHSV;
        }

        private int take_picture_function(int take_image, Mat imgHSV) {
                if (take_image==1){
                        Mat save_mat=new Mat();
                        Core.flip(imgHSV.t(),save_mat,1);
                        Imgproc.cvtColor(save_mat,save_mat,Imgproc.COLOR_RGB2HSV_FULL);
                        File folder = new File(Environment.getExternalStorageDirectory().getPath()+"/ImageHSV");
                        ...
                        String fileName=Environment.getExternalStorageDirectory().getPath()+"/ImageHSV/"+currentDateandTime+" .jpg";
